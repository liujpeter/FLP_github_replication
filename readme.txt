...
For more details on the methodology, see the FLP.pdf file in this folder. Note that this project is a work in progress and I am in the process of writing more detailed documentation and cleaning up parts of the code base.  

Here is a description of the relevant files to run the estimator. 
